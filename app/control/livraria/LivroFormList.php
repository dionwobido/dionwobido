<?php
/**
 * LivroFormList Form List
 * @author  <your name here>
 */
class LivroFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $genero_id = new TDBUniqueSearch('genero_id', 'db_livraria', 'Genero', 'id', 'descricao');
        $editora_id = new TDBUniqueSearch('editora_id', 'db_livraria', 'Editora', 'id', 'nome');


        // add the fields
        $this->form->addFields( [ new TLabel('Id') ], [ $id ], [ new TLabel('Titulo') ], [ $titulo ] );
        $this->form->addFields( [ new TLabel('Preco') ], [ $preco ], [ new TLabel('Estoque') ], [ $estoque ] );
        $this->form->addFields( [ new TLabel('Genero Id') ], [ $genero_id ], [ new TLabel('Editora Id') ], [ $editora_id ] );
        ...
        $column_estoque = new TDataGridColumn('estoque', 'Estoque', 'left');
        $column_genero_id = new TDataGridColumn('genero_id', 'Genero Id', 'left');
        $column_editora_id = new TDataGridColumn('editora_id', 'Editora Id', 'left');
        ...
        $this->datagrid->addColumn($column_editora_id);
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('db_livraria'); // open a transaction with database
    ...
    public function onSave( $param )
    {
        try
        {
            TTransaction::open('db_livraria'); // open a transaction
