 ...
 */
class AutorFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_Autor');
        $this->form->setFormTitle('Autor');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Autor
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new Autor($key, FALSE); // instantiates the Active Record
